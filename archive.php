...
<div class="khobor-container khobor-layout khobor-layout--<?php echo esc_attr( $sidebar_pos ); ?>">
	<div class="khobor-content">
		...
		<header class="khobor-archive-header">
			<h1 class="khobor-archive-title"><?php the_archive_title(); ?></h1>
			<?php
			$desc = get_the_archive_description();
			if ( $desc ) :
				?>
				<div class="khobor-archive-description"><?php echo wp_kses_post( $desc ); ?></div>
			<?php endif; ?>
		</header>

		<?php if ( have_posts() ) : ?>
			<div class="khobor-grid khobor-grid--3" id="khobor-archive-grid">
